            ...
            <AnimatePresence>
                {!isOpen && (
                    <motion.button
                        ...
                        className="fixed bottom-10 right-6 w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-primary to-primary-hover rounded-full shadow-2xl flex items-center justify-center hover:scale-110 transition-transform z-40"
                    >
