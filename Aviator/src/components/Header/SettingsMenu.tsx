...
const Menu = ({ setHowto }) => {
  ...
  useEffect(() => {
    window?.addEventListener("click", () => {
      ...
      try {
        if (userInfo.isMusicEnable === true) {
          let mainEle: any = document.getElementById("mainAudio");
          if (mainEle && mainEle.paused) {
            mainEle.volume = 0.5;
            const playPromise = mainEle.play();
              ...
              <div className="setting-second-block">
                ...
                <div className="setting-dropdown-item">
                  ...
                  <button
                    ...
                    onClick={() => {
                      const mainEle = document.getElementById("mainAudio") as HTMLAudioElement;
                      if (mainEle) {
                        console.log("Test Music: Found element", mainEle);
                        console.log("Test Music: src", mainEle.currentSrc);
                        console.log("Test Music: readyState", mainEle.readyState);
                        console.log("Test Music: error", mainEle.error);
                        mainEle.volume = 1.0;
                        mainEle.play()
                          .then(() => toast.success("Music playing!"))
                          .catch(e => {
                            console.error("Test Music Failed:", e);
                            toast.error(`Music failed: ${e.message}`);
                          });
                      } else {
